...
class WeightHeuristicNavButton extends StatelessWidget{
  const WeightHeuristicNavButton({super.key, required this.updateConfigData});
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.of(context).push(HeroDialogRoute(builder: (context){
              return WeightPopOutTile(updateConfigData: (configKey, newValue){
...
class WeightPopOutTile extends StatelessWidget{
...
//   const WeightPopOutTile({super.key, required this.updateConfigData});
//
//   final Function(String, String) updateConfigData;
//
//   @override
...
//   var menuItems = ["Weight Heuristic","HE", "Sigmoid", "tahn"];
//
//   @override
//   Widget build(BuildContext context) {
//
...
//                        height: 100,
//                        width: 300,
//                        child: DropDownMenu(widget.updateConfigData, menuItems, "Weight Heuristic")
//                      )
//                     ]
//                   )
//               )
